...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/YOUR_GITHUB_USERNAME/rich_text_extraction'
  spec.metadata['changelog_uri'] = 'https://github.com/YOUR_GITHUB_USERNAME/rich_text_extraction/blob/main/CHANGELOG.md'
