...
module RichTextExtraction
  module Helpers
    ##
    # OpenGraphHelpers provides OpenGraph data processing and rendering functionality.
    #
    # This module includes methods for fetching, processing, and rendering
    # OpenGraph metadata from URLs.
    #
